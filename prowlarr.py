...
CONFIG_DATA = {
    'api_key': '584c138bbc43453281b123893e372b13',  # prowlarr api
    'tracker_first': True,          # (False/True) add tracker name to beginning of search result
    'url': 'http://172.22.0.2:9696',  # prowlarr url
}
